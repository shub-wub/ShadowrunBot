...
const event: BotEvent = {
    ...
    async execute(message, client: Client) {
        ...
        if (message.channelId === guildRecord?.leaderboardChannelId) {
            console.log(currentTime + " Message delete from leaderboard channel with ID " + message.id);
            ...
            console.log(currentTime + " Message delete from ranked channel with ID " + message.id);
            ...
            console.log(currentTime + " Message delete from matches channel with ID " + message.id);
